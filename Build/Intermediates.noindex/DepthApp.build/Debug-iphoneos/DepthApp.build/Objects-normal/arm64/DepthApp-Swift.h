...
#ifndef DEPTHAPP_SWIFT_H
#define DEPTHAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DepthApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8DepthApp11AppDelegate")
...
SWIFT_CLASS("_TtC8DepthApp14ViewController")
@interface ViewController : UIViewController <AVCaptureDepthDataOutputDelegate, AVCaptureFileOutputRecordingDelegate>
