...
class ViewController: UIViewController, AVCaptureFileOutputRecordingDelegate, AVCaptureDepthDataOutputDelegate {
    ...
    //let camCalData = AVCameraCalibrationData
    ...
    // called when you first run the app
    ...
    func depthDataOutput(_ output: AVCaptureDepthDataOutput, didOutput depthData: AVDepthData, timestamp: CMTime, connection: AVCaptureConnection) {
        ...
        if(self.isRecording) {
            ...
            print("Intrinsic Matrix: \(depthData.cameraCalibrationData?.intrinsicMatrix)")
            var iMatrix = "\(depthData.cameraCalibrationData?.intrinsicMatrix)"
            print("Intrinsic Matrix Dimensions: \(depthData.cameraCalibrationData?.intrinsicMatrixReferenceDimensions)")
            print("Extrinsic Matrix: \(depthData.cameraCalibrationData?.extrinsicMatrix)")
